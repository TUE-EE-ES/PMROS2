...
#ifndef RCLCPP__DUMMY_MEASUREMENT_WRITER_HPP_
#define RCLCPP__DUMMY_MEASUREMENT_WRITER_HPP_

#include "rclcpp/measuring/measurement_writer_interface.hpp"

namespace rclcpp {

class DummyMeasurementWriter : public IMeasurementWriter {
public:
...
#endif // RCLCPP__DUMMY_MEASUREMENT_WRITER_HPP_