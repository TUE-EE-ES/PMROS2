...
rcl_action_get_zero_initialized_goal_info(void)
{
  ...
  memset(&goal_info, 0, sizeof(rcl_action_goal_info_t)); // must be zero-initialized like this because struct topology is unknown due to possible presence of vandenhoven timestamp and identifier.
  return goal_info;
}
...
rcl_action_get_zero_initialized_goal_status_array(void)
{
  ...
  memset(&status_array, 0, sizeof(rcl_action_goal_status_array_t));
  return status_array;
}
...
rcl_action_get_zero_initialized_cancel_request(void)
{
  ...
  memset(&request, 0, sizeof(rcl_action_cancel_request_t));
  return request;
}
...
rcl_action_get_zero_initialized_cancel_response(void)
{
  ...
  memset(&response, 0, sizeof(rcl_action_cancel_response_t));
  return response;
}
